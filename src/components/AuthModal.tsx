...
export function AuthModal({ isOpen, onClose, users, currentUser, onAuthenticate, onRegister, onLogout }: AuthModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Content Card */}
      <div className="relative bg-[#15121e] border border-white/5 w-full max-w-md rounded-[32px] overflow-hidden shadow-2xl flex flex-col max-h-[90vh] z-10 animate-in fade-in zoom-in duration-200">
